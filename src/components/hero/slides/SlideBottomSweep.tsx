...
export default function SlideBottomSweep({ badge, title, subtitle, onSearchClick }: HeroSlideProps) {
  ...
  return (
    ...
    >
      ...
      >
        {/* Badge */}
        <motion.div variants={shouldReduce ? undefined : bottomSweepChildVariants} className="flex justify-end">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/10 backdrop-blur-sm rounded-full mb-3 sm:mb-4 border border-white/20">
