...
export default function SlideTopRightPanel({ badge, title, subtitle, onSearchClick }: HeroSlideProps) {
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          {/* Badge */}
          <motion.div variants={shouldReduce ? undefined : topRightChildVariants} className="flex justify-end">
          ...
          <motion.p
            variants={shouldReduce ? undefined : topRightChildVariants}
            className="text-base sm:text-lg md:text-xl text-gray-200 drop-shadow-md max-w-md ml-auto leading-relaxed font-light"
          >
            {subtitle}
          </motion.p>
